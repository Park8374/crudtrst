...
<%
	...
	System.out.println("DB접속 성공");
	   ...
	   String sql = "SELECT team_no AS teamNo , team_name AS teamName , team_count AS teamCount , team_begin AS begin , team_end AS end, createdate , updatedate FROM team";
	   ...
	   while(rs.next()) {
	      ...
	      t.teamBegin =      rs.getString("begin");
	      t.teamEnd =      rs.getString("end");
