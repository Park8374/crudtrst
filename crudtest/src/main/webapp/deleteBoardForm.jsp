   ...
   <form action="<%=request.getContextPath()%>/deleteBoardAction.jsp">
      <table border="1">
         ...
         <tr>
            <td>board_content</td>
            <td>
               <textarea rows="8" cols=30 readonly="readonly" name="boardContent"><%=board.boardContent%></textarea>
            </td>
         </tr>
         <tr>
            <td>board_writer</td>
         ...
         <tr>
            <td>board_pw</td>
            <td>
               <input type="text" name="boardPw" value="<%=board.boardPw%>"readonly="readonly">
            </td>
         </tr>
         <tr>
            <td>createdate</td>
         ...
         <tr>
            <td colspan="2"><button type="submit">삭제</button></td>
         </tr>
      </table>
   </form>
</body>
